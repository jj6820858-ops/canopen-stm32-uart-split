...
| **0x301** | **RPDO2 Node1** | **7677** | **命令** | **8B** | **电机A 位置命令** |
| **0x302** | **RPDO2 Node2** | **4541** | **命令** | **8B** | **电机B 位置命令** |
| **0x303** | **RPDO2 Node3** | **4630** | **命令** | **8B** | **电机C 位置命令** |
| **0x304** | **RPDO2 Node4** | **4546** | **命令** | **8B** | **电机D 位置命令** |
...
**关键发现**：
- Node1 位置恒定为 500（可能是回零位置）
- Node2 位置恒定为 85333（旋转位置）
- Node3 位置在变化 → **这是执行实际运动扫描的轴**
- Node4 位置为负值 → 可能是升降轴
...
```c
// CANopen 节点定义
#define NODE_MOTOR_A    1  // 0x301 RPDO2, 0x181 TPDO1
#define NODE_MOTOR_B    2  // 0x302 RPDO2, 0x182 TPDO1
#define NODE_MOTOR_C    3  // 0x303 RPDO2, 0x183 TPDO1 (主要运动轴)
#define NODE_MOTOR_D    4  // 0x304 RPDO2, 0x184 TPDO1
