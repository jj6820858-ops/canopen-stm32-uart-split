...
| 轴 | 机构 | CAN 位置 PDO | modes | position | velocity | status_word | control_word | current |
|----|------|-------------|-------|----------|----------|-------------|--------------|---------|
| **mX** | X / 针头旋转 | 0x301 | 0x2001 | 0x2002 | 0x2003 | 0x2004 | 0x2005 | 0x2028 |
| **mY** | Y / 转盘 | 0x302 | 0x2006 | 0x2007 | 0x2008 | 0x2009 | 0x200A | 0x2029 |
| **mZ** | Z / 上下 | 0x303 | 0x200B | 0x200C | 0x200D | 0x200E | 0x200F | 0x202A |
| **mE** | E / 柱塞泵 | 0x304 | 0x2010 | 0x2011 | 0x2012 | 0x2013 | 0x2014 | — |
| **mT** | 历史/辅助对象 | 0x305 | 0x2015 | 0x2016 | 0x2017 | 0x2018 | 0x2019 | — |
| **mB** | 电流反馈 | — | — | — | — | — | — | 0x202B |
