...
/*
 * Modbus register map for 快检设备协议 (implemented in reg_router.c)
 ...
 * ═══════════════════════════════════════════════════════════════════
 *
 *  CANopen configuration is fully defined in ObjDict.c / ObjDict.h
 *  (generated by objdictgen). No runtime override — OD is the single
 *  source of truth for node IDs, COB-IDs, PDO mappings, and SDO channels.
 *
 *  Modbus slave address and serial port are configured below.
 */
...
/* FreeModbus Master register map (kept for compilation) */
